    ...
    fnManupalateData() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            if (this.data.length > 1) {
                ...
                let form = new _angular_common_http__WEBPACK_IMPORTED_MODULE_5__["HttpParams"]().set('data', JSON.stringify(dataToPost));
                const result = yield this.service.post('test', form);
                if (result.msg) {
